...
### Висновки
В ході виконання практичної роботи було створено декілька іконок використовуючи інструменту Pen Tool у Figma. В результаті я засвоїв принцип побудови кривих Безьє за допомогою цього інструменту, що дозволяє точно формувати контури та плавні лінії в подальших проєктах.
