...
- [6 урок - Figma 2020 - Створення прототипу] - Про створення прототипу в Figma.

Для створення деталізованого вайрфрейму інтернет-магазину було використано сайт [Yes, Original](https://yesoriginal.com.ua/uk) як основне джерело структури та змісту. З нього запозичено механіку роботи сторінок, текстові матеріали та зображення. Значки імпортовані з бібліотеки [Google Fonts](https://fonts.google.com/icons).

Основні сторінки інтернет-магазину:
* Головна сторінка з банером, категоріями, картками товарів і навігацією.
* Декілька сторінок товарів з фото, описом, характеристикамии, цінами та кнопками купівлі.
* Модальні вікна різного призначення.

Усі макети створені у розмірі екранів - desktop, що дозволяє зосередитись на повноцінному відображенні контенту та зручній навігації.
...
### Висновки
Під час роботи було створено деталізований клікабельний вайрфрейм інтернет-магазину "yes, original" у Figma для десктопних екранів. Були розроблені основні сторінки (Головна, Сторінка товару) та декілька модальних вікон. Також створено бібліотеку компонентів для забезпечення  інтерфейсу. Виконання роботи закріпило навички структурного планування, застосування ключових UX-принципів для e-commerce, а також поглибило знання про створення повторюваних компонентів та налаштування прототипування у Figma для тестування користувацьких сценаріїв.
