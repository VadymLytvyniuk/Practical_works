...
3. WebP (lossy)
   * Фотографія
    ...
    * Скріншот
      ...
      На мою думку, мінімальний рівень якості, при якому зображення залишається прийнятним - 10.3%. Він забезпечує ефективну оптимізацію, коли файл стає набагато меншим (44.8 Кб), проте залишається достатньо деталізованим.
