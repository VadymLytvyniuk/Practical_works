...
* Split Complementary (Розділена комплементарна) - Вона викориостовує основний колір і два кольори, що розташовані поруч із його прямим комплементарним кольором.
