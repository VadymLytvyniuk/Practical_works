...
### Висновки
На основі проведеної роботи, на мою думку, для інтерфейсів, де важливо дотримуватися правил побудови палітр і забезпечувати комфортне сприйняття, найкраще підходять монохроматичні та аналогічні гармонії. Вони створюють спокійну, збалансовану та ненав’язливу кольорову систему, яка не перевантажує користувача під час тривалого використання. Також ефективними є приглушені палітри, адже вони зберігають гармонійність і водночас дозволяють контролювати яскравість та контраст. У випадках, коли потрібна більша гнучкість, можна використовувати власні (Сustom) палітри, поєднуючи переваги цих підходів - стабільність монохроматичної, природність аналогічної та м’якість приглушених відтінків. Загалом, для інтерфейсів найважливішим є поєднання гармонії та читабельності, тому палітра має не тільки виглядати узгоджено, але й відповідати вимогам контрастності. Таке поєднання забезпечить комфортний та доступний користувацький досвід.
